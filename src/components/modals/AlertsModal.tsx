        ...
        <div className="p-4 sm:p-5 overflow-y-auto flex-1 flex flex-col gap-3">
          {alerts.length === 0 ? (
            <div className="p-8 text-center flex flex-col items-center">
              <div className="w-12 h-12 rounded-full bg-[#E0EAE4] text-[#079455] flex items-center justify-center mb-2">
                <CheckCircle2 className="w-6 h-6" />
              </div>
              <h4 className="font-bold text-sm text-[#1A1A1A]">No Pending Alerts</h4>
              <p className="text-xs text-[#6E7B74] mt-0.5">All inventory batches, Khata accounts, and compliance licenses are healthy.</p>
            </div>
          ) : (
            alerts.map((alert) => {
